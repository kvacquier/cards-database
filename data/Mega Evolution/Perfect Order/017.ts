...
const card: Card = {
	...
	abilities: [{
		...
		effect: {
			...
			'es-mx': "Si este Pokémon está en el Puesto Activo y resulta dañado por un ataque de los Pokémon de tu rival (incluso si queda Fuera de Combate), descarta 1 Energía del Pokémon Atacante.",
		},
	}],
