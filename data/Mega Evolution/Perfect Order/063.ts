...
const card: Card = {
	...
	attacks: [
	{
		...
		effect: {
			...
			'es-mx': "Lanza 1 moneda hasta que salga cruz. Busca en tu baraja una cantidad de Energías Básicas igual o inferior al número de caras que hayan salido y únelas a este Pokémon. Después, baraja las cartas de tu baraja.",
		},
	},
	{
		...
		effect: {
			...
			'es-mx': "Este Pokémon pasa a estar Dormido.",
		},
	},
	],
