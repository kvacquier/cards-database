...
const card: Card = {
	...
	effect: {
		...
		'es-mx': "Una vez durante el turno de cada jugador, ese jugador puede buscar en su baraja 1 Pokémon Básico y ponerlo en su Banca. Después, ese jugador baraja las cartas de su baraja. Si un jugador busca en su baraja de esta manera, su turno termina.",
	},
