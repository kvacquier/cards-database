...
const card: Card = {
	...
	attacks: [
	{
		...
		effect: {
			...
			'es-mx': "Pon todas las Energías unidas a este Pokémon en tu baraja y baraja todas las cartas, y este ataque hace 220 puntos de daño a uno de los Pokémon de tu rival. (No apliques Debilidad y Resistencia a los Pokémon en Banca).",
		},
	},
	],
