...
const card: Card = {
	...
	effect: {
		...
		'es-mx': "Roba cartas hasta tener 5 cartas en tu mano. Antes de robar cartas, puedes descartar cualquier cantidad de cartas de tu mano. (Si no puedes robar ninguna carta de esta manera, no puedes usar esta carta).",
	},
